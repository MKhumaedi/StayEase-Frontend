...
export default function AboutHero({ language }: AboutHeroProps) {
  ...
  return (
    <section className="relative overflow-hidden bg-linear-to-br from-indigo-950 via-slate-900 to-indigo-900 py-24 px-6 md:px-12 text-center text-white rounded-3xl mb-12 shadow-xl">
