...
export default function Home({ onNavigate }: HomeProps) {
  ...
  return (
    <div className="font-sans text-slate-800 antialiased bg-slate-50/50 pb-20">
      ...
      <div className="relative h-[580px] sm:h-[640px] md:h-[700px] w-full overflow-hidden bg-slate-950 mt-[-76px] pt-16">
        ...
        <div className="absolute inset-0 z-20 flex flex-col items-center justify-center text-center px-6 max-w-4xl mx-auto pt-10">
